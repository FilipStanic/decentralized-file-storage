...
import { ExternalLink, Download, Database, Info } from 'lucide-react';
                ...
                <div className="flex-1 p-4 overflow-auto bg-gray-50 dark:bg-gray-900">
                    ...
                    <div className="mb-6">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h1 className="text-2xl font-semibold text-gray-800 dark:text-white">IPFS Files</h1>
                        </div>
                    ...
                    {ipfsFiles.length > 0 ? (
                        ...
                        <div className="text-center py-8 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white">No IPFS Files Found</h3>
                            <p className="mt-2 text-gray-500 dark:text-gray-400">
                                Upload files to IPFS to see them here.<br />
                                Files stored on IPFS are accessible even when BlockStore is offline.
                            </p>
                        </div>
                    )}
                </div>
